                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form id="delete-form-{{$product_value->id}}" action="{{ route('product.destroy',$product_value->id) }}" method="POST">
                                                ...
                                                <button type="button" class="btn btn-md"><i
                                                        class="nav-icon fas fa-times" data-toggle="modal" data-target="#modal-delete-{{$product_value->id}}"></i></button>
                                            </form>
                                            
                                        </td>
                                        
                                    </tr>
                                    <div class="modal fade" id="modal-delete-{{$product_value->id}}" tabindex="-1" role="dialog" aria-hidden="true">
