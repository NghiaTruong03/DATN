                                            ...
                                            <div class="thumb">
                                                ...
                                                <div class="actions">
                                                    ...
                                                    <a href="#" class="action quickview" data-link-action="quickview"
                                                        ...
                                                        data-bs-target="#modal-quickview-{{ $product_value->id }}"><i
            ...
            <div class="row">
                ...
                <div class="col-lg-auto col-md-auto col-12">
                    <ul class="product-tab-nav nav">
                        ...
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                                href="#tab-product-bestsellers">Bán chạy</a></li>
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                                href="#tab-product-itemssale">Đang giảm giá</a></li>
                    </ul>
                </div>
                <!-- Tab End -->
            </div>
                                        ...
                                        <div class="new-product-item swiper-slide">
                                            ...
                                            <div class="product">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <h5 class="title"><a
                                                            href="single-product.html">{{ $newArrivalProduct->name }}
                                                        </a>
                                                    </h5>
                                                    <span class="price">
                                                        <span
...
<!-- Deal Area Start -->
<div class="deal-area mb-100px mt-100px" data-bg-image="{{url('assets/shop_pages/assets')}}/images/deal-img/deal-bg-2.jpg">
    <div class="container ">
        <div class="row">
            <div class="col-12">
                <div class="deal-inner position-relative pt-100px pb-100px">
                    ...
                    <div class="deal-image">
                        <img class="img-fluid" src="{{url('assets/shop_pages/assets')}}/images/deal-img/woman.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="testi-inner">
                        ...
                        <div class="testi-author">
                            <div class="author-img">
                                <img src="{{ url('assets/shop_pages/assets') }}/images/testimonial-image/1.png" alt="">
                            </div>
                ...
                <div class="swiper-slide">
                    <div class="testi-inner">
                        ...
                        <div class="testi-author">
                            <div class="author-img">
                                <img src="{{ url('assets/shop_pages/assets') }}/images/testimonial-image/2.png" alt="">
                            </div>
                            <div class="author-name">
                ...
                <div class="swiper-slide">
                    <div class="testi-inner">
                        ...
                        <div class="testi-author">
                            <div class="author-img">
                                <img src="{{ url('assets/shop_pages/assets') }}/images/testimonial-image/3.png" alt="">
                            </div>
                            <div class="author-name">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 mb-md-30px mb-lm-30px">
                    <div class="single-blog">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{ url('assets/shop_pages/assets') }}/images/blog-image/1.jpg"
                ...
                <div class="col-lg-4 mb-md-30px mb-lm-30px">
                    <div class="single-blog ">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{ url('assets/shop_pages/assets') }}/images/blog-image/2.jpg"
                                    class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                ...
                <div class="col-lg-4">
                    <div class="single-blog">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{ url('assets/shop_pages/assets') }}/images/blog-image/3.jpg"
                                    class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
