                                        ...
                                        <div class="thumb">
                                            ...
                                            <div class="actions">
                                                ...
                                                <a href="#" class="action quickview" data-link-action="quickview"
                                                    ...
                                                    data-bs-target="#modal-quickview-{{$product_value->id}}"><i class="pe-7s-search"></i></a>
                                                    ...
                                                    <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                                                        <div class="product-details-content quickview-content">
                                                            ...
                                                            <div class="pricing-meta">
                                                                <ul>
                                                                    <li class="old-price not-cut">{{ $product_value->price}}</li>
                                                                </ul>
                                                            </div>
                                                            <div class="pro-details-rating-wrap">
                                                                ...
                                                                <span class="read-review"><a class="reviews" href="#">( 5 Đánh giá
                                                                        )</a></span>
                                                            </div>
                                                            ...
                                                            <div class="pro-details-quality">
                                                                ...
                                                                <div class="pro-details-cart">
                                                                    <a href="{{route("add_to_cart", ['id' => $product_value->id])}}" title="Add To Cart" type="button" class=" add-cart">Mua ngay
                                                                    </a>
                                                                </div>
